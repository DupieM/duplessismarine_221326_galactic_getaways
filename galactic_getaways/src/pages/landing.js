...
function Landing(){
    return (
        ...
        <div className="App_landing">
            ...
            <h2 className="Main_Heading">Visit a different planet</h2>

            <p className="Body">
                Welcome to Celestial Voyages, where your dreams of interplanetary exploration come to life. 
                Join us in venturing beyond the stars, discovering the wonders of otherworldly landscapes.
            </p>
